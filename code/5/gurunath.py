...
def elitism(problem, population, retain_size):
    ...
    sortedpop = [(point, fitness(problem, population, point)) for point in population]
    sortedpop.sort(key=lambda a: a[1], reverse=True)
    
    return [sortedpop[i][0] for i in range(retain_size)]
